...
public class StrategieDeBase implements Strategie
{
	public int choixCarte(ArrayList<Carte> cartesCompatibles) {
		...
		if(joueurEnCours.getCartes().get(i).getValeur().equals("1")&& Partie.getPartie().getManche().getVarianteManche() instanceof Variante5) {
			Variante5.nombreAs ++;
		}
		...
		if(joueurEnCours.getCartes().get(i).getValeur().equals("8")&& Partie.getPartie().getManche().getVarianteManche() instanceof Variante5) {
